          ...
          {view==='chat' && (
            <>
              <div className="chat-area">
                {messages.length===0 ? (
                  <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', flex:1, gap:20, textAlign:'center', padding:'40px 16px' }}>
                    ...
                    <div style={{ fontSize:13, color:'#8888a0', maxWidth:360, lineHeight:1.6 }}>
                      Consulte a DIS-NOR-030 Rev.07. Figuras e tabelas aparecem automaticamente nas respostas.
                    </div>
